    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-primary-500-500">TurnoFacil CO</h1>
            </div>
            <nav className="flex items-center space-x-4">
              <a href="#beneficios" className="text-gray-600 hover:text-primary-500-500 transition-colors">
                Beneficios
              </a>
              <a href="#precios" className="text-gray-600 hover:text-primary-500-500 transition-colors">
                Precios
              </a>
              <a href="#contacto" className="text-gray-600 hover:text-primary-500-500 transition-colors">
                Contacto
              </a>
              <Link href="/login">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center">
              <div className="text-primary-500-500 mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">Para pequeñas empresas</p>
            ...
            <Card className="ring-2 ring-primary">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">Para empresas en crecimiento</p>
                <div className="text-4xl font-bold text-primary-500 mb-6">
                  $199.000
                  <span className="text-lg font-normal text-gray-500">/mes</span>
                </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card>
            <form onSubmit={handleContactSubmit} className="space-y-6">
              ...
              />
              <div>
                <label className="block text-caption text-gray-600 mb-1">
                  Mensaje
                </label>
                <textarea
                  className="w-full px-sm py-sm rounded-md border border-gray-300 focus:border-primary focus:ring-primary bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-opacity-20"
                  rows={4}
      ...
      <footer className="bg-neutral-black text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#precios" className="text-gray-300 hover:text-white">Precios</a></li>
          ...
          <div className="mt-8 pt-8 border-t border-neutral-dark-gray text-center text-gray-300">
      ...
      >
        <form onSubmit={handleContactSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select className="w-full px-sm py-sm rounded-md border border-gray-300 focus:border-primary focus:ring-primary bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-opacity-20">
